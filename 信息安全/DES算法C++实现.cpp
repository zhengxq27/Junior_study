...
int main() {
	cout << " _________DES算法__________" << endl << endl;
	cout << "|         1.加密           |" << endl;;
	cout << "|         2.解密           |"  << endl; 
	...
	while(true)
	{
		...
		else if( choice == "2") 
		{
			...
			string S;
			cin >> S;
			bitset<64> plain1 = charToBitset(S.c_str());
			bitset<64> temp_plain = decrypt(plain1);
			file1.open("D://b.txt", ios::binary | ios::out);
			file1.write((char*)&temp_plain,sizeof(temp_plain));
			string str1;
			getline(file1,str1);
			file1.close();
			cout << "解密结果可在D://b.txt中查看。" << endl; 
			break;
		}
